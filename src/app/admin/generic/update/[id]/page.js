...
export default function UpdateGenericPage() {
  ...
  const onSubmit = (e) => {
    e.preventDefault();
    dispatch(updateGeneric({ ...form, id }))
      .unwrap()
      .then((res) => {
        console.log("Generic updated:", res);
  ...
  return (
    <div className="w-full text-gray-700 ">
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-xl font-bold">Update Generic</h1>
